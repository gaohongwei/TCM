var app = angular.module('app');
  ...
  app.controller('task_optionsController', ['$scope','Tasks','TaskOptions','OptionUsers',function($scope,Tasks,TaskOptions,OptionUsers){
